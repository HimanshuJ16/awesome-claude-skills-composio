...
- [Algo-Trading-Skills](https://github.com/HimanshuJ16/Algo-Trading-Skills) - 501-skill library for building and auditing trading systems: broker API integration, real-time market data, backtesting without look-ahead bias, risk controls and kill switches, execution algorithms, financial ML, crypto custody, and regulatory compliance (SEC Rule 15c3-5, MiFID II, FCA, SEBI). Each skill ships a standalone Python reference implementation and its own unittest suite. *By [@HimanshuJ16](https://github.com/HimanshuJ16)*
